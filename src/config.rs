...
pub const BLOCK_TIME: u64 = 15 * 1; // Block Time in milliseconds
pub const MINIMUM_DIFFICULTY: u64 = BLOCK_TIME * 1;
...
pub const GENESIS_BLOCK: &str = ""; // Genesis block in hexadecimal format
