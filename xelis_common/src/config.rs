...
pub const CHAIN_SYNC_REQUEST_MAX_BLOCKS: usize = 512; // allows up to X blocks id (hash + height) 
...
pub const PEER_TIMEOUT_REQUEST_OBJECT: u64 = 10000; // millis until we timeout
